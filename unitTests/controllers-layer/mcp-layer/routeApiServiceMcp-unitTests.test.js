...
describe("CreatePlayerSessionMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/playerSession/create-playersession-api.js",
      {
        apiLayer: { CreatePlayerSessionManager: ManagerStub },
        "../../PlayerSessionServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createPlayerSession");
