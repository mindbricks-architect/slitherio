...
const playerSessionPackage = grpcObject.playerSession;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, { hello: "hello, this is slitherio-playersession-service" });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(playerSessionPackage.playerSessionService.service, {
  helloMessage,
  ...sessionRouter,
});
