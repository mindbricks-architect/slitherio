...
console.log("Starting slitherio-playersession-service service...");
...
const start = async () => {
  process.title = "node-slitherio-playersession-service";
  ...
  try {
    ...
    await setRedisData(
      "slitherio-playersession-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key slitherio-playersession-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "slitherio-playersession-service is listening HTTP/REST port " +
...
/* starting the server slitherio-playersession-service .... */
start();
