...
const exposedHeaders = [
  "slitherio-access-token",
  "slitherio-refresh-token",
  "set-cookie",
];
if (!corsOrigin) {
  app.use(
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "slitherio-playerSession-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="slitherio-playerSession-postman-collection.json"',
  );
