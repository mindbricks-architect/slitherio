...
// This script is called from the GetPlayerSessionManager
...
const dbScriptGetPlayersession = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await PlayerSession.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetPlayersession",
      {
...
module.exports = dbScriptGetPlayersession;
